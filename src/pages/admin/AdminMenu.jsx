        ...
        <div className={styles.tableWrap}>
          <table className={styles.table}>
            ...
            <tbody>
                ...
                <tr key={item.id} className={!item.available ? styles.rowDisabled : ''}>
                  <td>
                    <div className={styles.imgCell}>
                      {item.image_url
                        ? <img src={item.image_url} alt={item.name} className={styles.tableImg} />
              ...
              {filtered.length === 0 && (
                <tr>
                  <td colSpan={7} className={styles.noItems}>No items found</td>
                </tr>
              )}
            </tbody>
          </table>
        ...
        >
          <div className={styles.modal}>
                ...
                {form.image_url ? (
                  ...
                  <label className={styles.uploadBox}>
                    ...
                    {uploadingImg
                      ...
                      : <><span style={{fontSize:'2rem'}}>📷</span><span>Click to upload image</span><small>JPG, PNG, WebP — max 5MB</small></>
                    }
                  </label>
                )}
              ...
              <div className={styles.formGrid}>
                <div className={styles.fg}>
                  ...
                  <input
                    ...
                    placeholder="e.g. Rich Stir-Fry Noodles"
                  />
                </div>
                <div className={styles.fg}>
            ...
            <div className={styles.modalFooter}>
              ...
              >
                {saving
                  ? <><span className={styles.miniSpin} /> Saving…</>
